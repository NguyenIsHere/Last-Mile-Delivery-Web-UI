...
import { ReactComponent as Money } from '../../assets/icons/usd-square.svg'
...
import ZaloPay from '../../assets/images/Logo FA-14.png'

const MoneyIcon = () => {
  return (
    <Money
      style={{
        fill: 'var(--blue-color-60)',
        width: '20px',
        height: '20px'
      }}
    />
...
const DotIcon = () => {
  return (
    <Dot
      style={{ fill: 'var(--blue-color-100)', width: '14px', height: '14px' }}
    />
  )
}
...
const Upload_4 = () => {
  ...
  const [expandedRow2, setExpandedRow2] = useState(null) // Lưu row đang mở

  const handleToggleRow2 = index => {
    setExpandedRow2(prevIndex => (prevIndex === index ? null : index)) // Toggle hiển thị
  }
  ...
  const subItems = [
    { id: 1, name: 'Hoàng Trọng', price: 213000, date: 'Hôm nay, đặt ngay' },
    { id: 2, name: 'Linh Chi', price: 53000, date: 'Hôm nay, đặt ngay' }
  ]

  return (
    <div className='Upload_4__container'>
              ...
              <div className='new-booking-page'>
                ...
                <div className='header-2'>
                  <div className='left-header-2'>
                    <h1>Bước 4: Thanh toán và đặt hàng</h1>
                  </div>
                ...
                <div className='container-with-fixed'>
                  <div className='header-3-group'>
                    <div className='header-3' style={{ marginBottom: 0 }}>
                      <div className='header-3-title'>
                        Phương thức thanh toán
                      </div>
                      <div className='header-3-content'>
                        <div className='header-3-content-row'>
                          <div className='header-3-content-item'>
                            <div className='header-3-content-item-icon-left'>
                              <img src={ZaloPay} alt='' />
                            </div>
                            <div className='header-3-content-item-text'>
                              ZaloPay
                            </div>
                            <div className='header-3-content-item-icon-right'>
                              <img
                                src='https://express.grab.com/book/static/images/circle.19rm-Gs.svg'
                                alt=''
                              />
                            </div>
                          </div>
                          <div className='header-3-content-item'>
                            ...
                            <div className='header-3-content-item-icon-right'>
                              <img
                                src='https://express.grab.com/book/static/images/circle-clicked.2VGMX7L.svg'
                                alt=''
                              />
                            </div>
                          </div>
                  ...
                  >
                                    ...
                                    <div className='modal-service-btn'>
                                      <div className='modal-service-btn-content'>
                                        ...
                                        <div className='modal-service-text-group'>
                                          ...
                                          <div className='modal-service-text-sub'>
                                            Giao siêu tốc dành riêng cho thực
                                            phẩm
                                          </div>
                                        </div>
                                      </div>
                    ...
                    <div className='header-3'>
                      <div className='header-3-title'>Ưu đãi</div>
                      <div className='header-3-content'>
                        <div className='header-3-content-row'>
                          <div
                            className='header-3-content-item'
                            onClick={openModal4}
                          >
                            <div className='header-3-content-item-icon-left'>
                              <img
                                src='https://express.grab.com/book/static/images/promo-icon.3u5sTMX.svg'
                                alt=''
                              />
                            </div>
                            <div className='header-3-content-item-text'>
                  ...
                  <div className='price-container'>
                    <div className='price-content'>
                      <div className='title-row'>Giá giảm</div>
                      <div className='price-row-group'>
                        {rows.map((row, index) => (
                          <div key={row.id}>
                            ...
                            <div
                              className='row-item'
                              onClick={() => handleToggleRow2(index)}
                            >
                              <DotIcon />
                              <div className='row-item-text'>{row.text}</div>
                              <DownIcon />
                            </div>

                            {/* Danh sách con, chỉ hiển thị nếu expandedRow === index */}
                            {expandedRow2 === index && (
                              <div className='row-item-list'>
                                {subItems.map(subItem => (
                                  <div
                                    key={subItem.id}
                                    className='row-item-list-item'
                                  >
                                    <DestinationIcon />
                                    <div className='row-item-list-item-text-group'>
                                      <div className='row-item-text-top'>
                                      ...
                                      <div className='row-item-sub-text'>
                                        {subItem.date}
                                      </div>
                                    </div>
                                  </div>
                      ...
                      <div className='total-group'>
                        <div className='total-row'>
                          <div
                            className='total-row-left'
                            style={{ fontSize: '14px' }}
                          >
                            5 đơn giao hàng
                          </div>
                          <div
                            className='total-row-right'
                            style={{ fontSize: '14px' }}
                          >
                            465.000
                        ...
                        >
                          <div className='total-row-left'>Tổng cộng</div>
                        ...
                        <div className='order-btn-row'>Đặt 5 đơn</div>
                      </div>
                    </div>
                  </div>
                </div>
